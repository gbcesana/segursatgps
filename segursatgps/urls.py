...
urlpatterns = [
    ...
    path('reports/extended-detailed-report/', reports_views.extended_detailed_report_view, name='extended-detailed-report'),
    ...
    path('reports/geofence-long-speed-report/', reports_views.geofence_long_speed_report_view, name='geofence-long-speed-report'),
    ...
    path('maps/multiple-unit-group-map-2/', maps_views.multiple_unit_group_map_2_view, name='multiple-unit-group-map-2'),
    path('maps/multiple-unit-group-map-4/', maps_views.multiple_unit_group_map_4_view, name='multiple-unit-group-map-4'),
    path('maps/multiple-unit-group-map-6/', maps_views.multiple_unit_group_map_6_view, name='multiple-unit-group-map-6'),
    path('maps/multiple-unit-group-map-8/', maps_views.multiple_unit_group_map_8_view, name='multiple-unit-group-map-8'),
    ...
    path('web/api/users/update-user/<int:id>/', users_views.update_user),
    ...
    path('web/api/units/update-group/<int:id>/', units_views.update_group),
    path('web/api/units/delete-group/<int:id>/', units_views.delete_group),
    ...
    path('web/api/geofences/create-geofence/', geofences_views.create_geofence),
    path('web/api/geofences/update-geofence/<int:id>/', geofences_views.update_geofence),
    ...
    path('web/api/locations/insert-location-batch/', locations_views.insert_async_location_batch),
    ...
    path('web/api/reports/location-report/', reports_views.get_location_report),
    ...
    path('web/api/reports/stop-report/', reports_views.get_stop_report),
    path('web/api/reports/speed-report/', reports_views.get_speed_report),
    path('web/api/reports/long-speed-report/', reports_views.get_long_speed_report),
    path('web/api/reports/geofence-long-speed-report/', reports_views.get_geofence_long_speed_report),
    path('web/api/reports/driving-style-report/', reports_views.get_driving_style_report),
    path('web/api/reports/mileage-report/', reports_views.get_mileage_report),
    path('web/api/reports/telemetry-report/', reports_views.get_telemetry_report),
    ...
    path('web/api/triggers/create-1012-fleet-trigger/', triggers_views.create_1012_fleet_trigger),
    ...
    path('web/api/triggers/update-1012-fleet-trigger/<int:id>/', triggers_views.update_1012_fleet_trigger),
    ...
    path('web/api/triggers/create-1007-unit-trigger/', triggers_views.create_1007_unit_trigger),
    path('web/api/triggers/create-1008-unit-trigger/', triggers_views.create_1008_unit_trigger),
    path('web/api/triggers/update-generic-unit-trigger/<int:id>/', triggers_views.update_generic_unit_trigger),
    path('web/api/triggers/update-1003-unit-trigger/<int:id>/', triggers_views.update_1003_unit_trigger),
